...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        self.curr_steering_angle = stabilize_steering_angle(self.curr_steering_angle, new_steering_angle,
                                                            len(lane_lines),self.max_angle_deviation_two_lanes,self.max_angle_deviation_one_lane)
...
def detect_line_segments(cropped_edges):
    ...
    line_segments = cv2.HoughLinesP(cropped_edges, rho, angle, min_threshold, np.array([]), minLineLength=5,
                                    maxLineGap=4)
...
def stabilize_steering_angle(curr_steering_angle, new_steering_angle, num_of_lane_lines, max_angle_deviation_two_lanes, max_angle_deviation_one_lane
                             ):
    """
...
if __name__ == '__main__':
    ...
    test_video('/home/jmugicagonz/DeepPiCar/driver/data/video01')
    #test_photo('/home/jmugicagonz/DeepPiCar/driver/data/road3_240x320.png')
