...
/*PreProcessing::PreProcessing(const Rect &_regiaoDeInteresse, IPM *_ipm, bool _verbose, bool _display) {
...
PreProcessing::PreProcessing(const Rect &_regiaoDeInteresse, bool _verbose, bool _display) {
	regiaoDeInteresse = _regiaoDeInteresse;
	verbose = _verbose;
	display = _display;
}

Mat1b PreProcessing::executar(const Mat3b &colorFrame, Mat1b &outGrayFrameRoi, IPM *_ipm) {
...
Mat1b PreProcessing::executar(const Mat3b &colorFrame, IPM *_ipm) {
...
void PreProcessing::view(const Mat3b &entrada, const Mat1b &saida) {
...
vector<Point> PreProcessing::getVerticesIPM() {
...
Mat1b PreProcessing::getMascaraIPM(int _dilateSize) {
